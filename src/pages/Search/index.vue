  ...
  export default {
    ...
    methods: {
      ...
      removeKeyword(){
        ...
        // 通知兄弟组件Header清除关键字
        this.$bus.$emit("clear");
        // 清除地址栏中的params参数 路由跳转
        this.$router.push({name:"search",query:this.$route.query});
      },
      // 自定义i事件回调
      trademarkInfo(trademark){
        // 整理品牌字段的参数 “ID：品牌名称
        this.searchParams.trademark = `${trademark.tId}:${trademark.tmName}`;
        this.getData();
      },
      // 删除品牌面包屑
      removeTrademark(){
    ...
    // 组件挂载之前执行一次
    beforeMount() {
      Object.assign(this.searchParams,this.$router.query,this.$router.params);
    },
    mounted() {
    ...
    watch:{
      ...
      $route(newValue,OldValue){
        ...
        // 严谨：删除query参数，如果路径中含有params参数就不应该删除，路由跳转的时候继续带着
